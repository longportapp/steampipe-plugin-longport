...
func tableLongPortHistoryOrder(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "longport_history_order",
		Description: "History Orders.",
		List: &plugin.ListConfig{
			Hydrate:    listLongPortHistoryOrder,
...
func listLongPortHistoryOrder(ctx context.Context, d *plugin.QueryData, p *plugin.HydrateData) (interface{}, error) {
