...
func tableHistoryExecutions(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "longport_history_executions",
		Description: "History Executions.",
		List: &plugin.ListConfig{
			Hydrate:    listHistoryExecutions,
...
func listHistoryExecutions(ctx context.Context, d *plugin.QueryData, p *plugin.HydrateData) (interface{}, error) {
